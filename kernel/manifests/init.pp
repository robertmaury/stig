...
# All classes and resource type definitions must be in separate files 
# in the manifests directory of their module. This is functionally 
# identical to declaring all classes and defines in init.pp, but 
# highlights the structure of the module and makes everything more legible
# 
# Need to split this defined type out by itself.
#
