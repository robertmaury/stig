...
class packages {
  package {
    ...
    [
      # if services must be enabled, follow prose guide 
  ...
  #   changes => [
  #     'set use-ipv6 no',
  #     #uncomment this and comment out above line in using ipv6
  #     #'set use-ipv4 no'
  #   ];
  #
  ...
  # Configure vsftpd Service if Necessary, follow prose guidance 
  # for more instructions, requires vsftpd.lns
  #augeas {
