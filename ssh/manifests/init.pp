...
class ssh {
  ...
  # This is an exported resource. This will enable all managed 
  # boxes to update their ssh_known_hosts files automatically.

  # To add static hosts (i.e., not managed by puppet) add the 
  # following line: 
